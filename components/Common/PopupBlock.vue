<template>
    <div class="overlay" @click="outSideOverlay">
        <div class="popup-container" @click="insideOverlay">
            <div class="popup-nav">
                <slot name="nav">
                    <div class="popup-title">Block {{ label }}</div>
                </slot>
            ...
            <div class="popup-body">
                <slot name="body">
                    <div class="body-content">
                        <textarea v-model="content" spellcheck="false" class="inp-content-report" placeholder="Enter reason"></textarea>
                    </div>
                </slot>
            </div>
            <div class="popup-action">
                <slot name="action">
                    <button class="btn btn--dark btn--full btn--large" @click="confirm">
                        Confirm
                    </button>
                </slot>
            </div>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async confirm() {
      try {
        await this.$api.report.createBlock({
          action: this.action,
